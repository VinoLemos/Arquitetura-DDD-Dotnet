...
namespace Api.Service.Test.Usuario
{
    public class UsuarioTestes
    {
        ...
        public UserDtoCreateResult createResult = new UserDtoCreateResult();
        public UserDtoUpdate userDtoUpdate = new UserDtoUpdate();
        public UserDtoUpdateResult updateResult = new UserDtoUpdateResult();
        ...
        public UsuarioTestes()
        {
            ...
            createResult = new UserDtoCreateResult
            {
                Id = IdUsuario,
                Name = NomeUsuario,
                Email = EmailUsuario,
            ...
            updateResult = new UserDtoUpdateResult
            {
                Id = IdUsuario,
                Name = NomeUsuario,
                Email = EmailUsuario,
